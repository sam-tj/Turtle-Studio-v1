...
BLOCKLY_TOOLBOX_XML["toolboxturtleStudio"] =
  ...
  '<category name="%{BKY_CAT_ARDUINO_I}" categorystyle="arduino_category">' +
  ...
  "</category>" +
  '<category name="%{BKY_CAT_ARDUINO_O}" categorystyle="arduino_category">' +
  ...
  "</category>" +
  '<category name="%{BKY_CAT_ARDUINO_OTHER}" categorystyle="arduino_category">' +
  ...
  // +    '<category name="Built-in" categorystyle="turtle_category">'
  ...
  // +    '</category>'
  // +    '<category name="%{BKY_CAT_I2C_LCD}" categorystyle="turtle_category">'
  // +                '<block type="turtle_i2c_lcd_print"></block>'
  // +    '</category>'
  // +    '</category>'
  ...
  '<category name="%{BKY_CAT_ARDUINO_I}" categorystyle="grove_category">' +
  ...
  "</category>" +
  '<category name="%{BKY_CAT_ARDUINO_O}" categorystyle="grove_category">' +
