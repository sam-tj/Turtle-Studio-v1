...
var MSG = {
    ...
    xmlError: "Could not load your saved file. Perhaps it was created with a different version of TSF?",
    ...
    saveCodeButton_span: "Export Code as .ino",
    newButton_span: "New Turtle project",
    save_span: "Save file name?",
    saveXMLButton_span: "Save as Turtle Studio file",
    loadXMLfakeButton_span: "Load Turtle Studio file",
    loadXML_span: "Replace existing blocks?\n'Cancel' will merge.",
    loadXML_error_span: "Error parsing XML:\n",
    resetButton_span: "Reset TS",
    resetQuestion_span: "Reset TS and",
    ...
    helpModalSpan_text:        
        ...
        '<tbody>' +
        '<tr>' +
        '<td style="width: 142px;"><img src="./turtleStudio/media/logo_only.png" alt="" width="129" height="144" /></td>' +
        '<td>' +
