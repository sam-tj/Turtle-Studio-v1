...
function setOnOffLine() {
    ...
    if (location.protocol === 'file:') {
        document.body.style.backgroundColor = '#DB3A34';
        document.getElementById('CLI_content').style.backgroundColor = '#323031';
        document.getElementById('setup_content').style.backgroundColor = '#323031';
